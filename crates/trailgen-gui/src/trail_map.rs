...
impl GpuTrailTile {
        ...
        let gpu_laws = mesh
            ...
            .map(|law| {
                GpuLaw::forge(
                    ...
                    f64::from(paint.cadence_cells_per_world),
                )
            })
            .collect::<Vec<_>>();
    ...
    fn refresh_laws(
        ...
        if self.law_cells_per_world.to_bits() == cells_per_world.to_bits() {
            return 0;
        }
        scratch.clear();
        scratch.extend(
