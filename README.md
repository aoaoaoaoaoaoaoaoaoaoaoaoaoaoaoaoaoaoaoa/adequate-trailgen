...
- `sources/discovery.md`: human-readable source coverage, acquisition plan, official/practical source hints, local candidates, and adapter registry
...
- `routes/generated.geojson`: Pareto-ranked generated loops with persisted route scores, constraint penalties, terrain/access fractions, low-confidence and dubious segments, difficulty hotspots, and source provenance summaries
