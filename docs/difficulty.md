...
The edge stores both the scalar total and the factor breakdown. Route metrics sum those factors, and reports show route-level factor shares plus the largest edge-factor contributors. This makes a high scalar score inspectable instead of mystical.
