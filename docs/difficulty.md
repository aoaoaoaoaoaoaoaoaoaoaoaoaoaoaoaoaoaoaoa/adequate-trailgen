...
- `technical`: rough-terrain and steep-grade pressure × `technical_penalty` × distance cost
- `navigation`: weak terrain evidence, unknown terrain, and crossing complexity × `navigation_penalty` × distance cost
