...
- validate advertised CRS metadata; vector geometries must normalize to lon/lat WGS84/CRS84 at the adapter boundary. Native WGS84/CRS84, declared EPSG:3857 Web Mercator, and WGS84 UTM (EPSG:326xx/327xx) are implemented for vectors; GeoTIFF and VRT DEMs accept affine WGS84 degrees, EPSG:3857 metres, or WGS84 UTM metres (EPSG:326xx/327xx), including rotated/sheared transforms where advertised. Other projected CRS require an explicit reprojection adapter rather than silent ingestion
