...
- OSM XML network adapters should stay way-focused unless relation semantics are explicitly modeled: normalize walkable ways, preserve way IDs, access, foot direction, surface, confidence, and ODbL provenance
