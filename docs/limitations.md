...
- Arbitrary projected GeoTIFF DEMs remain a planned seam. Current elevation sampling supports Arc/Info ASCII Grid, affine WGS84 or EPSG:3857 single-band GeoTIFF DEMs including rotated/sheared `ModelTransformationTag` rasters, and simple GDAL VRT wrappers around geographic GeoTIFF DEMs. Shapefile vector support exists for trail-network polylines, terrain overlays, access/closure overlays, and road/hydrology context linework.
