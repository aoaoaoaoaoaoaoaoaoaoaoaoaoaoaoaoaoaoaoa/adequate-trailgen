...
- OSM XML/PBF ingestion normalizes walkable ways into graph drafts. It does not yet consume OSM route relations, turn restrictions, or Overpass/planet-diff workflows.
