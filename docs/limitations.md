...
- GeoTIFF/VRT DEMs are planned seams, not implemented adapters. Current elevation sampling supports Arc/Info ASCII Grid. Shapefile vector support exists for trail-network polylines, terrain overlays, access/closure overlays, and road/hydrology context linework.
